...
public class TradePane extends JLayeredPane {
    ...
    private void addTradeButtons() {
        ...
        for(int i = 1; i <= cards.size(); i++) {
            ...
            button.setSelectedIcon(JUtils.imageIcon("images/kleine_karten/" + getColor(i) + "_filled.png"));
            button.setDisabledIcon(JUtils.imageIcon("images/kleine_karten/disabled.png"));
