...
public class HousePane extends JLayeredPane {
    ...
    public HousePane(){
        ...
        moveHouseToStreet(Street.CHAUSSESTRASSE);
        moveHouseToStreet(Street.CHAUSSESTRASSE);
        moveHouseToStreet(Street.CHAUSSESTRASSE);
        moveHouseToStreet(Street.CHAUSSESTRASSE);
        moveHouseToStreet(Street.SEESTRASSE);
        moveHouseToStreet(Street.SEESTRASSE);
        moveHouseToStreet(Street.SEESTRASSE);
        moveHouseToStreet(Street.SEESTRASSE);
        moveHouseToStreet(Street.OPERNPLATZ);
        moveHouseToStreet(Street.OPERNPLATZ);
        moveHouseToStreet(Street.OPERNPLATZ);
        moveHouseToStreet(Street.OPERNPLATZ);
        moveHouseToStreet(Street.BAHNHOFSTRASSE);
        moveHouseToStreet(Street.BAHNHOFSTRASSE);
        moveHouseToStreet(Street.BAHNHOFSTRASSE);
        moveHouseToStreet(Street.BAHNHOFSTRASSE);
    }
